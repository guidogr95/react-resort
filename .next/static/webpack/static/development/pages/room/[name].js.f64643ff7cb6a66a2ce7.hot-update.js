...
var room = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(room, [{
    ...
    value: function getDerivedStateFromProps(props, state) {
      var getRoom;
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function getDerivedStateFromProps$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              console.log('yesy');
              getRoom = this.context.getRoom;
              _context2.next = 4;
              return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(getRoom(this.state.slug));
...
//# sourceMappingURL=[name].js.f64643ff7cb6a66a2ce7.hot-update.js.map