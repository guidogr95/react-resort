...
var ChatInstance = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(ChatInstance, [{
    ...
    value: function componentDidUpdate(prevState, prevProps) {
      ...
      if (_babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(this.state.currentRoom).length !== 0 && prevProps.messages.length !== this.state.messages.length) {
        this.setState({
...
//# sourceMappingURL=chat.js.a7c37dc17bacec24ce36.hot-update.js.map