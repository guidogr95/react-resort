...
var ChatComponent = /*#__PURE__*/function (_Component) {
  ...
  function ChatComponent(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "toggleModal", function () {
      _this.setState({
      ...
      if (this.context.authenticated || this.context.authenticated === null) {
        ...
        return (// <div className="chat-component">
          ...
          __jsx("div", {
            ...
            __self: this
          }, this.state.modalShow ? __jsx(react_icons_md__WEBPACK_IMPORTED_MODULE_14__["MdClear"], {
            className: this.state.modalShow ? "cross-show" : "cross-hide",
            __source: {
              fileName: _jsxFileName,
              lineNumber: 60
            },
            ...
            className: this.state.modalShow ? "chat-show" : "chat-hide",
            __source: {
              fileName: _jsxFileName,
              lineNumber: 61
            },
...
//# sourceMappingURL=_app.js.694b33d565f259373a1e.hot-update.js.map