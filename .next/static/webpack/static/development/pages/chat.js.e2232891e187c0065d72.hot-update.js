...
var ChatInstance = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(ChatInstance, [{
    ...
    value: function componentDidUpdate(prevState, prevProps) {
      console.log('length', _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(this.state.currentRoom).length);
      ...
      if (prevProps.messages.length !== this.state.messages.length) {
        ...
        if (_babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(prevProps.currentRoom).length !== 0) {
          console.log('height', document.getElementById("".concat(this.state.currentRoom.createdAt)).clientHeight);
          this.setState({
            scrollHeight: document.getElementById("".concat(this.state.currentRoom.createdAt)).clientHeight
          });
        }
      }
    }
...
//# sourceMappingURL=chat.js.e2232891e187c0065d72.hot-update.js.map