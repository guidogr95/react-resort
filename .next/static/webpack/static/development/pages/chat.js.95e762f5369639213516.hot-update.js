  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ChatInstance, [{
    ...
    value: function componentDidUpdate(prevState, prevProps) {
      if (prevProps.messages.length !== this.state.messages.length) {
        ...
        console.log('now', this.state.messages.length); // if (Object.keys(prevProps.currentRoom).length !== 0 ) {
...
//# sourceMappingURL=chat.js.95e762f5369639213516.hot-update.js.map