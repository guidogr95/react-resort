...
var ChatInstance = /*#__PURE__*/function (_Component) {
  ...
  function ChatInstance(props) {
          ...
          hooks: {
            onMessage: function onMessage(message) {
              ...
              react_scroll__WEBPACK_IMPORTED_MODULE_12__["animateScroll"].scrollToBottom({
                containerId: _this.state.currentRoom.id ? _this.state.currentRoom.id.replace(/\s/g, '') : _this.state.currentRoom.id
              });
            },
    ...
    _this.state = {
      ...
      isUserTyping: false,
      text: '',
      id: _this.state.currentRoom.id ? _this.state.currentRoom.id.replace(/\s/g, '') : _this.state.currentRoom.id
    };
    return _this;
  }
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ChatInstance, [{
    ...
    value: function render() {
      ...
      var id = this.state.currentRoom.id ? this.state.currentRoom.id.replace(/\s/g, '') : this.state.currentRoom.id;
      return __jsx("div", {
...
//# sourceMappingURL=chat.js.3f0cf048f02ce2e88bf0.hot-update.js.map