...
var ChatInstance = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(ChatInstance, [{
    ...
    value: function componentDidUpdate(prevState, prevProps) {
      if (_babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(this.state.currentRoom).length > 0) {
        console.log(this.state.currentRoom.id, document.getElementById("".concat(this.state.currentRoom.createdAt.replace(/[-\-:]/g, ''))).clientHeight);
      }

      if (prevProps.messages.length !== this.state.messages.length) {
        console.log('prev', prevProps.messages);
        console.log('now', this.state.messages); // if (Object.keys(prevProps.currentRoom).length !== 0 ) {
      ...
      return __jsx("div", {
        ...
        return __jsx("li", {
          ...
          onClick: function onClick() {
            return document.getElementById("".concat(_this2.state.currentRoom.createdAt.replace(/[-\-:]/g, ''))).clientHeight;
          },
          __source: {
            fileName: _jsxFileName,
            lineNumber: 127
...
//# sourceMappingURL=chat.js.f2ec5be16d1b22f24073.hot-update.js.map