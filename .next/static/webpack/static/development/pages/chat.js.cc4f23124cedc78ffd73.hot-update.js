...
var ChatInstance = /*#__PURE__*/function (_Component) {
  ...
  function ChatInstance(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "onEnterPress", function (e) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ChatInstance, [{
    ...
    value: function componentDidUpdate(prevState, prevProps) {
      if (prevProps.messages.length !== this.state.messages.length) {
        console.log('prev', prevProps.messages);
        console.log('now', this.state.messages);

        try {
          console.log('height', document.getElementById("".concat(this.state.currentRoom.createdAt.replace(/[-\-:]/g, ''))).clientHeight);
        } catch (_unused) {} // if (Object.keys(prevProps.currentRoom).length !== 0 ) {
    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        id: this.state.currentRoom.createdAt !== 'undefined' ? this.state.currentRoom.createdAt.replace(/[-\-:]/g, '') : "",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 119
        },
        ...
        return __jsx("li", {
          ...
          onClick: function onClick() {
            return console.log(_this2.state.scrollHeight);
          },
          __source: {
            fileName: _jsxFileName,
            lineNumber: 126
...
//# sourceMappingURL=chat.js.cc4f23124cedc78ffd73.hot-update.js.map