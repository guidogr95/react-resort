...
var ChatInstance = /*#__PURE__*/function (_Component) {
  ...
  function ChatInstance(props) {
    ...
    _this.state = {
      ...
      isUserTyping: false,
      text: '',
      id: _this.state.currentRoom ? _this.state.currentRoom.id.replace(/\s/g, '') : _this.state.currentRoom.id
    };
    return _this;
  }
...
//# sourceMappingURL=chat.js.45da01a81104f8f07271.hot-update.js.map