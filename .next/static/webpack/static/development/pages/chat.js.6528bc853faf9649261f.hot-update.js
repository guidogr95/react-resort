  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(ChatInstance, [{
    ...
    value: function componentDidUpdate(prevProps) {
      if (_babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(this.state.currentRoom).length > 0) {
        if (this.context.activeWindow === this.state.currentRoom.id && prevProps.activeWindow !== this.state.activeWindow) {
          this.setState({
...
//# sourceMappingURL=chat.js.6528bc853faf9649261f.hot-update.js.map